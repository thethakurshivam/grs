...
import { FileText, ArrowLeft, Calendar, Building, Target } from "lucide-react";
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">All MOUs</h1>
            <p className="text-muted-foreground">Loading MOU data...</p>
          </div>
        </div>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">All MOUs</h1>
            <p className="text-muted-foreground">Error loading MOU data</p>
          </div>
        </div>
