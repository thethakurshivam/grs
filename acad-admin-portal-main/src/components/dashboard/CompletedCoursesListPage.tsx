...
const CompletedCoursesListPage = () => {
  const { courses, loading, error, refetch } = useCompletedCoursesCount();
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Loading completed courses data...</p>
          </div>
        </div>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Completed Courses</h1>
            <p className="text-muted-foreground">Error loading completed courses data</p>
          </div>
        </div>
        ...
        {courses.length === 0 ? (
          <Card className="border-0 shadow-md">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">No Completed Courses Found</h3>
              <p className="text-muted-foreground mb-4">
                No courses have been marked as completed yet.
              </p>
