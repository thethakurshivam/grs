      ...
      <Card className="hover:shadow-lg transition-all duration-200 border-0 shadow-md">
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="text-3xl font-bold text-black">Loading...</div>
            <p className="text-sm text-black">Fetching participants data</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  if (error) {
    return (
      <Card className="hover:shadow-lg transition-all duration-200 border-0 shadow-md">
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="text-3xl font-bold text-black">Error</div>
      ...
      >
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <p className="text-sm text-black">Total students/professionals</p>
          </div>
        </CardContent>
      </Card>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-black">
                            Enrollment: {participant.enrollment_number}
                          </p>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-black">
                            {participant.birth_place}, {participant.birth_state}
                          </span>
                        </div>
